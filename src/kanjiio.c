 ...
 * $Id: kanjiio.c,v 1.20 2015-04-10 08:21:41 knok Exp $
 * Copyright (C) 1992
...
int input_GL = SETG0;
int input_GR = SETG3;
int input_G[5] = {ASCII, KATAKANA, KATAKANA, JIS83, KATAKANA};

int output_term_type = UNKNOWN;

int output_GL = SETG0;
int output_GR = SETG3;
int output_G[5] = {ASCII, KATAKANA, KATAKANA, JIS83, KATAKANA};
